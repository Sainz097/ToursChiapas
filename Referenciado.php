...
<div class="whitepaper">
    ...
    <div class="Data">
    	...
    	<div class="col1">
            ...
            <h4>Teléfono: <?php echo $telefono;?></h4>
            <h4>Correo: <?php echo $correo;?></h4>
            <h4>Cantidad: <?php echo $cantidad;?></h4>
        </div>
        <div class="col2">
        	<h2>Total, a pagar</h2>
            <h1>$<?php echo $cantidad*2500?><span>.00</span><small> MXN</small></h1>
            <span class="note">La comisión por recepción del pago varía de acuerdo con los términos y condiciones que cada cadena comercial establece.</span>
        </div>
    </div>
    ...
    <div>
    	...
    	<div class="col1">
            ...
            <ol>
            	<li>Acude a cualquier sucursal de los siguientes bancos</li>
                <li>Entrega al cajero el código de barras y menciona que realizarás un pago de servicio Paynet</li>
                <li>Realizar el pago en efectivo por la cantidad que viene en la parte superior </li>
